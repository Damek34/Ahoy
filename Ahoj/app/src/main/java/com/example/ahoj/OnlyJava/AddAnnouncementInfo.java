...
public class AddAnnouncementInfo {
    ...
    public AddAnnouncementInfo(String time_and_date, String companyName, String announcement_description, Date announcement_duration, String announcement_additional, String countryName) {
